(function initializeLaunchFrameLayouts(globalScope) {
  ...
  const IPAD_LAYOUT_PRESETS = Object.freeze({
    ...
    "immersive-overlap": Object.freeze({
      id: "immersive-overlap",
      label: "沉浸叠映",
      description: "大屏压场 · 浅色更佳",
      category: "ecosystem",
      badge: "iPad + iPhone",
      slotCount: 2,
      slots: Object.freeze([
        typedSlot("ipad", "primary", "iPad 主结果"),
        typedSlot("iphone", "support", "iPhone 入口"),
      ]),
      copy: Object.freeze({
        top: 90,
        left: 160,
      ...
      nodes: Object.freeze([
        typedDevice("ipad", 0, 1540, 450, 2200, 0.8, 2),
        typedDevice("iphone", 1, 400, 630, 600, -3.2, 4),
      ]),
      controls: Object.freeze(["scale", "y", "spread", "tilt", "mirror"]),
      annotations: null,
    }),
    "content-stage": Object.freeze({
      id: "content-stage",
      label: "双端展台",
      description: "大屏主场 · 深色更佳",
      category: "ecosystem",
      badge: "iPad + iPhone",
      slotCount: 2,
      slots: Object.freeze([
        typedSlot("ipad", "primary", "iPad 主内容"),
        typedSlot("iphone", "support", "iPhone 辅助内容"),
      ]),
      copy: ipadCenteredCopy,
      nodes: Object.freeze([
        typedDevice("ipad", 0, 1080, 530, 1850, -0.8, 2),
        typedDevice("iphone", 1, 2280, 650, 500, 2.3, 4),
      ]),
      controls: Object.freeze(["scale", "y", "spread", "tilt", "mirror"]),
      annotations: null,
    }),
